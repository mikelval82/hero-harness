...
class DeterministicModelPolicyTest(unittest.TestCase):
    def test_phase_complexity_and_retry_select_deterministically(self) -> None:
        ...
        self.assertEqual(policy.select("spec", "L", 0, CAPABILITIES).reason, "large task complexity")
    ...
    def test_forced_model_is_reproducible(self) -> None:
        ...
        self.assertEqual((selection.tier, selection.reason, selection.policy_version), ("forced", "explicit runtime override", "o4-v1"))
